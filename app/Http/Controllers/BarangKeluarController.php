...
class BarangKeluarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $dataTable = DataTables::of($data)
                ...
                ->addColumn('id_proyek', function ($row) {
                    if ($row->jenis_proyek === 'Bangunan') {
                        return optional(ProyekBangunan::find($row->id_proyek_bangunan))->nama_proyek;
                    } elseif ($row->jenis_proyek === 'Jalan') {
                        return optional(ProyekJalan::find($row->id_proyek_jalan))->nama_proyek;
                    } elseif ($row->jenis_proyek === 'Saluran') {
                        return optional(ProyekSaluran::find($row->id_proyek_saluran))->nama_proyek;
                    }
    ...
    public function create()
    {
        ...
        $proyek_bangunanList = ProyekBangunan::all();
        $proyek_jalanList = ProyekJalan::all();
        $proyek_saluranList = ProyekSaluran::all();

        return view('admin.barang_keluar.create', compact('barangList', 'proyek_bangunanList', 'proyek_jalanList', 'proyek_saluranList'));
    }
    ...
    public function show(Request $request, string $id)
    {
        ...
        return view('admin.barang_keluar.show', compact('dataBK', 'barangList', 'dataBKD', 'proyek_bangunanList', 'proyek_jalanList', 'proyek_saluranList'));
    }
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'id_proyek_bangunan' => 'required_if:jenis_proyek,Bangunan',
            'id_jalan' => 'required_if:jenis_proyek,Jalan',
            'id_saluran' => 'required_if:jenis_proyek,Saluran',
            'keterangan' => 'nullable',
        ...
        $messages = [
            ...
            'id_proyek_bangunan.required_if' => 'Proyek Bangunan wajib dipilih.',
            'id_jalan.required_if' => 'Proyek Jalan wajib dipilih.',
            'id_saluran.required_if' => 'Proyek Saluran wajib dipilih.',
        ...
        try {
            ...
            $BarangKeluar = BarangKeluar::create([
                ...
                'id_proyek_bangunan' => $request->id_proyek_bangunan ?? null,
                'id_proyek_jalan' => $request->id_proyek_jalan ?? null,
                'id_proyek_saluran' => $request->id_proyek_saluran ?? null,
