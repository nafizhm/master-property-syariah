...
class PengaturanMediaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = PengaturanMedia::orderBy('id', 'desc');
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            'nama_file' => 'required|mimes:jpg,jpeg,png|max:2048',
        ];

        $messages = [
            'nama_file.required' => 'File wajib diisi.',
            'nama_file.mimes'    => 'File harus berformat JPG, JPEG, atau PNG.',
            'nama_file.max'      => 'Ukuran file maksimal 2 MB.',
        ];
