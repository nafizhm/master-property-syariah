...
class GantiNamaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'biaya_ganti_nama.required'  => 'Biaya ganti nama harus diisi',
            'id_metode_bayar.required'   => 'Metode bayar harus diisi',
            'id_bank.required'           => 'Bank harus diisi',
            'lampiran_bukti.required_if' => 'Lampiran bukti harus diisi',
        ...
        try {
            ...
            $gn = GantiNama::create([
                ...
                'biaya_ganti_nama' => str_replace('.', '', $request->biaya_ganti_nama),
            ...
            $pemasukan = [
                ...
                'nominal'               => str_replace('.', '', $request->biaya_ganti_nama),
