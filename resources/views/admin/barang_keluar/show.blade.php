                            ...
                            <div class="card-body">
                                <form id="formData" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select select-jenis-proyek" name="jenis_proyek"
                                                id="jenis_proyek">
                                                <option value=""></option>
                                                <option value="Bangunan"
                                                    {{ $dataBK->jenis_proyek == 'Bangunan' ? 'selected' : '' }}>
                                                    Bangunan</option>
                                                <option value="Jalan"
                                                    {{ $dataBK->jenis_proyek == 'Jalan' ? 'selected' : '' }}>
                                                    Jalan</option>
                                                <option value="Saluran"
                                                    {{ $dataBK->jenis_proyek == 'Saluran' ? 'selected' : '' }}>
                                                    Saluran</option>
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control select-proyek-bangunan" name="id_proyek_bangunan"
                                                ...
                                                @foreach ($proyek_bangunanList as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $dataBK->id_proyek_bangunan == $data->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-3 d-none select-jalan">
                                            <select class="form-control select-proyek-jalan" name="id_jalan" id="id_jalan">
                                                ...
                                                @foreach ($proyek_jalanList as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $dataBK->id_jalan == $data->id ? 'selected' : '' }}>
                                                        {{ $data->nama_proyek }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-3 d-none select-saluran">
                                            <select class="form-control select-proyek-saluran" name="id_saluran"
                                                ...
                                                @foreach ($proyek_saluranList as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $dataBK->id_saluran == $data->id ? 'selected' : '' }}>
                                                        {{ $data->nama_proyek }}</option>
                                                @endforeach
                                            </select>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#jenis_proyek').on('change', function() {
                toggleProyek($(this).val())
            })

            toggleProyek($('#jenis_proyek').val())
        })
