                        ...
                        <div class="card">
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg">Data Marketing Offline</h3>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '[data-target="#modalForm"]', function() {
            $('#modalFormLabel').text('Tambah Marketing Offline');
        });
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            $.get(url, function(response) {
                if (response.status === 'success') {
                    $('#modalFormLabel').text('Edit Marketing Offline');
        ...
        $('#formData').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    audio.play();
                    let msg = id ? "Marketing Offline berhasil diupdate!" :
                        "Marketing Offline berhasil ditambahkan!";
