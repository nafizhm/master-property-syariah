        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header p-3 bg-indigo">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg text-white">Tambah Opname Proyek Bangunan</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="formData">
                                    ...
                                    <table class="table table-bordered data-table w-100">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="table-primary"><strong id="finalOpTotal">0
                                                        %</strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-indigo">
                    <h5 class="modal-title text-white font-weight-bold" id="modalFormLabel">Foto Opname</h5>
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                searching: false,
                info: false,
                ajax: "{{ route('proyek-bangunan.detail-create', $proyek->id) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = '{{ route('proyek-bangunan.detail-store', $proyek->id) }}';
            let method = 'POST';
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    window.location.href = "{{ route('proyek-bangunan.show', $proyek->id) }}";
                },
                error: function(xhr) {
                    if (xhr.status === 422) {
                        audio.play();
