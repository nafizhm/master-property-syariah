                        ...
                        <div class="card">
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg">Detail Opname Proyek Bangunan</h3>
                                    @if ($tampilkan_tombol)
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('proyek-bangunan.detail-create', $proyek->id) }}"
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                info: false,
                ajax: {
                    url: "{{ route('proyek-bangunan.show', $proyek->id) }}",
