                        ...
                        <div class="card">
                            <div class="card-header p-3 bg-indigo">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg text-white">Rekap Opname Proyek Bangunan</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row mb-3">
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                searching: false,
                info: false,
                ajax: "{{ route('proyek-bangunan.detail', $proyekDetail->id) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(document).on('click', '.lihat-lampiran', function() {
            ...
            $.ajax({
                url: `{{ route('getFoto.bangunan', ':id') }}`.replace(':id', id),
                method: 'GET',
        ...
        $(document).on('click', '.btn-delete-foto', function(e) {
            ...
            $.ajax({
                url: `{{ route('hapusFoto.bangunan', ':id') }}`.replace(':id', fotoId),
                method: 'DELETE',
                headers: {
