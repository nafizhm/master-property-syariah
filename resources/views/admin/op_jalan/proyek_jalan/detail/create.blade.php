                        ...
                        <div class="card">
                            <div class="card-header p-3 bg-warning">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg text-white">Tambah Opname Proyek Jalan</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="formData">
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                searching: false,
                info: false,
                ajax: "{{ route('proyek-jalan.detail-create', $proyek->id) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = '{{ route('proyek-jalan.detail-store', $proyek->id) }}';
            let method = 'POST';
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    window.location.href = "{{ route('proyek-jalan.show', $proyek->id) }}";
                },
                error: function(xhr) {
                    if (xhr.status === 422) {
                        audio.play();
