                        ...
                        <div class="card">
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg">Data Jenis Pekerjaan</h3>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '[data-target="#modalForm"]', function() {
            $('#modalFormLabel').text('Tambah Jenis Pekerjaan');
            $('#primary_id').val('');
        });
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                info: false, // matikan "showing x of y entries"
                lengthChange: false, // matikan "show entries"
                ajax: "{{ route('jenis-pekerjaan-saluran.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            $.get(url, function(response) {
                if (response.status === 'success') {
                    $('#modalFormLabel').text('Edit Jenis Pekerjaan');
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('jenis-pekerjaan-saluran.update', ['jenis_pekerjaan_saluran' => ':id']) }}'
                .replace(
                    ':id',
                    id) :
                '{{ route('jenis-pekerjaan-saluran.store') }}';
