    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 font-weight-bold text-lg text-dark">Siteplan Proyek</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    @foreach ($lokasiKavling as $index => $kav)
                                        <div class="tab-pane fade {{ $index == 0 ? 'show active' : '' }}"
                                            ...
                                            <a href="{{ route('siteplan-proyek.cetak.pdf', $kav->id) }}" target="_blank"
                                                class="btn btn-danger btn-sm mr-1">
                                                <i class="fas fa-file-pdf mr-1"></i> Cetak Denah PDF
                                            </a>
                                            <a href="{{ route('siteplan-proyek.cetak.jpg', $kav->id) }}" target="_blank"
                                                ...
                                                @foreach ($kav->kavlingPeta as $pt)
                                                    @php
                                                        ...
                                                        if (isset($units[$pt->kode_kavling])) {
                                                            ...
                                                            if ($proyek && $proyek->id_lokasi == $kav->id) {
                                                                $persen =
                                                                    $proyek->proyekBangunanDetail
                                                        ...
                                                        if (
                                                            $pt->customer &&
                                                            optional($pt->customer)->id_status_progres == 5
                                                        ) {
                                                    ...
                                                    @if ($pt->jenis_map == 'polygon')
                                                        <a href="javascript:void(0);" class="detail-button"
                                                            data-id="{{ $pt->id }}"
                                                            data-url="{{ route('siteplan-proyek.show', $pt->id) }}">
                                                            {!! str_replace(
                                                                ['[[1]]', '[[2]]', '[[3]]', '[[4]]'],
