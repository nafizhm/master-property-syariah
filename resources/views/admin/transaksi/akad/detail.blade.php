...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.hadir-button', function() {
            ...
            $.get(url, function(response) {
                if (response.status === 'success') {
                    ...
                    $('#lokasi_rumah').val(response.data.customer.lokasi.nama_kavling + ' (' + response.data.customer.kavling.kode_kavling + ')');
        ...
        $('#formHadir').on('submit', function(e) {
            ...
            let url = '{{ route('akad.seleksi-customer.update-hadir', ['id_detail' => ':id']) }}'.replace(':id', id);
            let method = 'POST';
